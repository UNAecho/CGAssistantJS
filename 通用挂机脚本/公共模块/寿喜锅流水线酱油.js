...
var thisobj = {
	...
	object : {
		...
		func : (cb) =>{
			...
			//2410是奇利村医院
			if (mapname != '亚留特村' && cga.GetMapIndex().index3 != 2410){
				console.log('去亚留特村...');
			...
			}else if(cga.GetMapIndex().index3 == 2410){
				console.log('在亚留特村医院，出发去采集...');
				cga.walkList([
					[2, 9, '亚留特村'],
					[66, 64, '芙蕾雅'],
					[624, 110],
