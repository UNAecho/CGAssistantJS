...
//挖一车，19组
const MATERIALS_MULTIPLE_COUNT = 720;
...
var thisobj = {
	...
	object : {
		...
		func : (cb) =>{
			...
			//3210是奇利村医院
			if (mapname != '奇利村' && cga.GetMapIndex().index3 != 3210){
				console.log('去奇利村...');
			...
			}else if(cga.GetMapIndex().index3 == 3210){
				console.log('在奇利村医院，出发去采集...');
				cga.walkList([
					[3, 9, '奇利村'],
					[79, 76, '索奇亚'],
					[359, 375],
