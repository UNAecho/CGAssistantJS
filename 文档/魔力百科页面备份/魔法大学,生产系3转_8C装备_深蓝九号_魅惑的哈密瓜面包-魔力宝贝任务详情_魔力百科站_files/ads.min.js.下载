...
{
	id: 6,
	link: 'http://www.cwmlbb.com/bbs/forum.php?gid=1',
	title: '重温魔力3.7怀旧新区q群275981240',
...
var fullScreenAds = function () {
	...
	// if (!window.localStorage.getItem('close_full_20220806')) {
	...
	// 			window.localStorage.setItem('close_full_20220806', 'true')
	// 		})
	// 	}, 100)
	// }
}
